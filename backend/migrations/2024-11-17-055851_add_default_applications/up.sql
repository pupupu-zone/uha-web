...
INSERT INTO "applications" ("name", "emoji", "logo_url", "color", "is_default", "is_archived", "aliases", "links", "category_id", "user_id", "id") VALUES
  ...
  ('Inferno Solutions', '🦀', 'https://s3.keireira.com/subsawwy-demo/media/apps/inferno-solutions.webp', '#000000', true, false, ARRAY[]::TEXT[], '{"referral": null, "promo": null, "homepage": "https://inferno.name/en/"}'::JSONB, '69e45825-a4e0-4c19-9351-ce95a807c158', '00000000-0000-0000-0000-000000000000', 'df03830e-31e6-424e-abdc-b03508d2767f'),
  ...
  ('PIA', '🦀', 'https://s3.keireira.com/subsawwy-demo/media/apps/private-internet-access.webp', '#75A55D', true, false, ARRAY['Private Internet Access'], '{"referral": null, "promo": null, "homepage": "https://privateinternetaccess.com/"}'::JSONB, 'ad7ebd55-5d7d-48b8-a6b1-077e4a9f7363', '00000000-0000-0000-0000-000000000000', '2924f74c-432f-41c7-bfe9-974b2458759e'),
  ...
  ('TESO', '🦀', 'https://s3.keireira.com/subsawwy-demo/media/apps/teso.webp', '#8F805F', true, false, ARRAY['The Elder Scrolls Online'], '{"referral": null, "promo": null, "homepage": "https://www.elderscrollsonline.com/"}'::JSONB, '4b28f8df-dfaa-4c96-baa5-d7b456122009', '00000000-0000-0000-0000-000000000000', 'a121c793-6c3c-4f91-aae5-64f7b5e6a03c'),
